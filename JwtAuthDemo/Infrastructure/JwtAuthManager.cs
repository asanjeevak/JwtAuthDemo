...
namespace JwtAuthDemo.Infrastructure
{
    ...
    public class JwtAuthManager : IJwtAuthManager
    {
        ...
        public void RemoveExpiredRefreshTokens(DateTime now)
        {
            ...
            {
                RemoveRefreshToken(expiredToken.Key); // optionally clean up expired refresh tokens
            }
        }

        public void RemoveRefreshToken(string key)
        {
            _usersRefreshTokens.TryRemove(key, out _);
        }
        ...
        public JwtAuthResult Refresh(string refreshToken, string accessToken, DateTime now)
        {
            ...
            if (refreshToken != existingRefreshToken.TokenString || existingRefreshToken.ExpireAt < now)
            {
                throw new SecurityTokenException("Invalid token");
            }
